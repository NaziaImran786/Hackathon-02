...
function CategoryImg() {
  return (
    ...
    <div className='w-full  mb-[125px]'>    
      ...
      <div className="relative min-w-[300px] min-h-[250px] lg:w-full w-[462px] ml-10 lg:mx-auto">
      <Image src="/c5.png" alt="category" layout='fill' objectFit="cover"></Image>
    </div>
    <div>
   ...
   {/* heading */}
      <div className="container mx-auto px-4 text-center mt-[96px] mb-[26px] ">
        <h1 className='text-[24px] lg:text-[42px] font-bold text-[#1A0B5B] font-josefin-sans'>Leatest Blog</h1>
    </div>


    <div className="container mx-auto px-4 mb-[53px] mt-[80px] pl-[32px]">
    <div className='mx-auto grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3'>
    <Card className="w-[320px] overflow-hidden bg-white shadow-md hover:shadow-lg transition-shadow">
      ...
      <div className="p-5 space-y-4">
        <div className="flex items-center gap-6 text-sm text-primary">
          <div className="flex items-center gap-2">
            ...
            <span className="font-josefin text-[#1A0B5B]">SaberAli</span>
          </div>
          <div className="flex items-center gap-2">
            <CalendarDays className="w-4 h-4 text-[#FFA454]" />
            <span className="font-josefin text-[#1A0B5B]">21 August,2020</span>
          </div>
        </div>
