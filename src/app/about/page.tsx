...
export default function AboutUs() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Client Section */}
      <div className="bg-[#FBFBFF] py-16 lg:py-24">
        <div className="container mx-auto px-4 lg:px-8">
...
//           <h2 className="text-2xl md:text-4xl font-bold text-[#101750] mb-4">About Us</h2>
...
//           </div>
//           <div>
//             <h3 className="text-3xl font-bold text-[#151875] mb-6">
...
//               faucibus vitae lobortis quis bibendum quam.
//             </p>
//             <Button className="bg-[#FB2E86]">Contact us</Button>
//           </div>
//         </div>
//       </div>
...
//           {feacherCards.map((feature, index) => (
//             <Card key={index} className="text-center shadow-lg hover:scale-110">
//               <CardContent className="p-6">
//                 <div className="mb-4 flex justify-center">
//                     <Image
//                     src={feature.image} alt="Feature" width={65} height={65}></Image></div>
//                 <h4 className="text-xl font-semibold text-[#151875] mb-4">{feature.title}</h4>
//                 <p className="text-[#8A8FB9]">
//                   {feature.description}
//                 </p>
//               </CardContent>
...
//       {/* Client Section */}
//       <div className="bg-[#FBFBFF] py-16">
//         <div className="container mx-auto px-4">
//           <h3 className="text-4xl font-bold text-center mb-12">Our Client Say!</h3>
//           <div className="max-w-2xl mx-auto text-center">
...
//               />
//             </div>
//             <h4 className="text-xl font-semibold mb-2">Selina Gomez</h4>
